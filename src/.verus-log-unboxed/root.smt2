...
;; Function-Def dist_unboxed::main
(push)
...
;; Function-Def dist_unboxed::lemma_mul_induction
(push)
 (declare-const f~2@ %%Function%%)
 (declare-const i~139@ Poly)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%fun%1. f~2@) (TYPE%fun%1. INT BOOL))
 )
 (assert
  (%B (%%apply%%0 f~2@ (I 0)))
 )
 (assert
  (forall ((i~25$ Poly)) (!
    ...
    :pattern ((%%apply%%0 f~2@ i~25$) (%%apply%%0 f~2@ (I (dist_unboxed!add.? i~25$ (I 1)))))
    :qid user_dist_unboxed__lemma_mul_induction_25
    :skolemid skolem_user_dist_unboxed__lemma_mul_induction_25
 )))
 (assert
  (forall ((i~70$ Poly)) (!
    (=>
    ...
    :pattern ((%%apply%%0 f~2@ i~70$) (%%apply%%0 f~2@ (I (dist_unboxed!sub.? i~70$ (I 1)))))
    :qid user_dist_unboxed__lemma_mul_induction_26
    :skolemid skolem_user_dist_unboxed__lemma_mul_induction_26
 )))
   ...
   (not (and
     (=>
      ...
      (and
       (=>
        %%location_label%%0
        (req%dist_unboxed!lemma_induction_helper. 1 f~2@ (%I i~139@))
       )
       (=>
        (ens%dist_unboxed!lemma_induction_helper. 1 f~2@ (%I i~139@))
        (=>
         %%location_label%%1
         (%B (%%apply%%0 f~2@ i~139@))
     ))))
     (=>
      (forall ((i~139$ Poly)) (!
        ...
        :pattern ((%%apply%%0 f~2@ i~139$))
        :qid user_dist_unboxed__lemma_mul_induction_24
        :skolemid skolem_user_dist_unboxed__lemma_mul_induction_24
      ))
      (=>
       %%location_label%%2
       (forall ((i~122$ Poly)) (!
         ...
         :pattern ((%%apply%%0 f~2@ i~122$))
         :qid user_dist_unboxed__lemma_mul_induction_23
         :skolemid skolem_user_dist_unboxed__lemma_mul_induction_23
 ))))))))
 (get-info :version)
 (assert
  %%query%%
