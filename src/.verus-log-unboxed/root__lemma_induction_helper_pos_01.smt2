...
;; MODULE ''
;; NonLinearArith/dist_unboxed.rs:48:7: 48:76 (#0)
...
;; Function-Def dist_unboxed::lemma_induction_helper_pos
(push)
 ...
 (assert
  (forall ((i~40$ Poly)) (!
    ...
    :pattern ((%%apply%%0 f~4@ i~40$))
    :qid user_dist_unboxed__lemma_induction_helper_pos_14
    :skolemid skolem_user_dist_unboxed__lemma_induction_helper_pos_14
 )))
 (assert
  (forall ((i~90$ Poly)) (!
    (=>
    ...
    :pattern ((%%apply%%0 f~4@ i~90$) (%%apply%%0 f~4@ (I (dist_unboxed!add.? i~90$ (I n~2@)))))
    :qid user_dist_unboxed__lemma_induction_helper_pos_15
    :skolemid skolem_user_dist_unboxed__lemma_induction_helper_pos_15
 )))
 (assert
  (forall ((i~131$ Poly)) (!
    (=>
    ...
    :pattern ((%%apply%%0 f~4@ i~131$) (%%apply%%0 f~4@ (I (dist_unboxed!sub.? i~131$ (I n~2@)))))
    :qid user_dist_unboxed__lemma_induction_helper_pos_16
    :skolemid skolem_user_dist_unboxed__lemma_induction_helper_pos_16
 )))
           ...
           (=>
            ...
            (and
             ...
             (and
              (=>
               %%location_label%%2
               (req%dist_unboxed!lemma_induction_helper_pos. n~2@ f~4@ tmp%2@)
              )
              (=>
               (ens%dist_unboxed!lemma_induction_helper_pos. n~2@ f~4@ tmp%2@)
               (=>
                (= tmp%3@ (%B (%%apply%%0 f~4@ (I (dist_unboxed!add.? (I (- x~6@ n~2@)) (I n~2@))))))
                (and
                 (=>
                  %%location_label%%3
                  tmp%3@
