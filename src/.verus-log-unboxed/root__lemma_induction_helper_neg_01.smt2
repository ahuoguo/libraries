...
;; MODULE ''
;; NonLinearArith/dist_unboxed.rs:68:7: 68:76 (#0)
...
;; Function-Def dist_unboxed::lemma_induction_helper_neg
(push)
 ...
 (assert
  (forall ((i~40$ Poly)) (!
    ...
    :pattern ((%%apply%%0 f~4@ i~40$))
    :qid user_dist_unboxed__lemma_induction_helper_neg_17
    :skolemid skolem_user_dist_unboxed__lemma_induction_helper_neg_17
 )))
 (assert
  (forall ((i~90$ Poly)) (!
    (=>
    ...
    :pattern ((%%apply%%0 f~4@ i~90$) (%%apply%%0 f~4@ (I (dist_unboxed!add.? i~90$ (I n~2@)))))
    :qid user_dist_unboxed__lemma_induction_helper_neg_18
    :skolemid skolem_user_dist_unboxed__lemma_induction_helper_neg_18
 )))
 (assert
  (forall ((i~131$ Poly)) (!
    (=>
    ...
    :pattern ((%%apply%%0 f~4@ i~131$) (%%apply%%0 f~4@ (I (dist_unboxed!sub.? i~131$ (I n~2@)))))
    :qid user_dist_unboxed__lemma_induction_helper_neg_19
    :skolemid skolem_user_dist_unboxed__lemma_induction_helper_neg_19
 )))
       ...
       (=>
        ...
        (=>
         ...
         (and
          (=>
           %%location_label%%0
           (req%dist_unboxed!lemma_induction_helper_pos. n~2@ f~4@ tmp%1@)
          )
          (=>
           (ens%dist_unboxed!lemma_induction_helper_pos. n~2@ f~4@ tmp%1@)
           (=>
            (= tmp%2@ (%B (%%apply%%0 f~4@ (I (dist_unboxed!sub.? (I (+ x~6@ n~2@)) (I n~2@))))))
            (and
             (=>
              %%location_label%%1
              tmp%2@
        ...
        (=>
         ...
         (and
          ...
          (and
           (=>
            %%location_label%%3
            (req%dist_unboxed!lemma_induction_helper_neg. n~2@ f~4@ tmp%3@)
           )
           (=>
            (ens%dist_unboxed!lemma_induction_helper_neg. n~2@ f~4@ tmp%3@)
            (=>
             (= tmp%4@ (%B (%%apply%%0 f~4@ (I (dist_unboxed!sub.? (I (+ x~6@ n~2@)) (I n~2@))))))
             (and
              (=>
               %%location_label%%4
               tmp%4@
